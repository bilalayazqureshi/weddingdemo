...
class WeddingEventWebControllerTest {
	...
	void test_ListView_ShowsEvents() throws Exception {
		...
		when(weddingEventService.getAllWeddingEvents()).thenReturn(events);
	...
	void test_EditEvent_WhenFound() throws Exception {
		...
		when(weddingEventService.getWeddingEventById(2L)).thenReturn(evt);
	...
	void test_EditEvent_WhenNotFound() throws Exception {
		when(weddingEventService.getWeddingEventById(3L)).thenReturn(null);
	...
	void test_PostEventWithoutId_ShouldInsertNewEvent() throws Exception {
		...
		verify(weddingEventService).insertNewWeddingEvent(new WeddingEvent(null, "E3", LocalDate.of(2025, 12, 12), "Milan"));
	}
	...
	void test_PostEventWithId_ShouldUpdateExistingEvent() throws Exception {
		...
		verify(weddingEventService).updateWeddingEventById(4L,
	...
	void test_DeleteEvent() throws Exception {
		...
		verify(weddingEventService).deleteWeddingEventById(5L);
	}
}
